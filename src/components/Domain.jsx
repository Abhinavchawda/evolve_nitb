    ...
    <div id='domains'>
      <div className='domain min-h-[100vh] text-white overflow-hidden mb-16'>
        ...
        <div className='mt-16 pt-10 flex justify-center items-center gap-7 flex-col sm:flex-row md:w-[90vw] lg:w-[70vw] mx-auto'>
          <div className='h-[70vh] w-4/5 md:w-1/3 flex justify-center items-center text-center relative hover:scale-105 transition-transform duration-300 ease-in-out rounded-sm my-20 md:my-0 object-cover'>
