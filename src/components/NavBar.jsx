            ...
            <div id='box' className='w-[90%] mt-5 border border-[rgb(71,255,47)] rounded-2xl backdrop-blur-lg fixed top-1 z-50 mx-auto transition-all duration-500 ease-in-out'>
                <div className='relative flex items-center justify-between h-20 rounded-2xl'>
                    ...
                    <ul ref={btn_ref} className='border-[rgb(71,255,47)] invisible lg:hidden rounded-2xl backdrop-blur-lg relative top-72 bg-zinc-800 w-[100vw] mr-20 flex flex-col items-center'>
                        ...
                        <li onClick={showMenu} className='rounded-xl font-semibold px-6 py-2 my-1 hover:text-[rgb(71,255,47)] text-center'><a href='#projects'>Projects</a></li>
                        <li onClick={showMenu} className='rounded-xl font-semibold px-6 py-2 my-1 hover:text-[rgb(71,255,47)] text-center'><a href='#events'>Events</a></li>
                        <li onClick={showMenu} className='rounded-xl font-semibold px-6 py-2 my-1 hover:text-[rgb(71,255,47)] text-center'><a href='#achievements'>Achievements</a></li>
                        <li onClick={showMenu} className='rounded-xl font-semibold px-6 py-2 my-1 hover:text-[rgb(71,255,47)] text-center'><a href='#team'>Team</a></li>
                        <li onClick={showMenu} className='rounded-xl font-semibold px-6 py-2 my-1 hover:text-[rgb(71,255,47)] text-center'><a href='#gallery'>Gallery</a></li>
                        <li onClick={showMenu} className='rounded-xl font-semibold px-6 py-2 my-1 hover:text-[rgb(71,255,47)] text-center'><a href='#contact'>Contact</a></li>
                    </ul>
