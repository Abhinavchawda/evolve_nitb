...
const NavBar = () => {
    ...
    return (
        <div className='flex justify-center items-center'>
            ...
            <div id='box' className='w-[93%] mt-5 border border-transparent hover:border-[rgb(71,255,47)] rounded-2xl backdrop-blur-lg fixed top-1 z-50 mx-auto transition-all duration-500 ease-in-out'>
                <div className='relative flex items-center justify-between h-20 rounded-2xl'>
                    ...
                    <ul ref={btn_ref} className='border-[rgb(71,255,47)] invisible lg:hidden rounded-2xl backdrop-blur-lg relative top-40 bg-zinc-950 p-2'>
