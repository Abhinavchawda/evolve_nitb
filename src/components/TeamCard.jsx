...
const TeamCard = (card) => {
    ...
    return (
        <div className='pt-10'>
            <div className="mx-auto mb-10 lg:mx-0 w-[250px] h-[350px] md:w-[280px] md:h-[400px] rounded-3xl overflow-hidden flex flex-col justify-center items-center border border-transparent hover:border-[rgb(71,255,47)] hover:scale-[110%] transition-transform duration-300 ease-in-out shadow-lg">
                ...
                >
                    ...
                    <div ref={showRef} className='z-10 absolute bottom-4 mx-auto opacity-0 bg-black bg-opacity-60 px-3 py-2 rounded-3xl border border-white transition-opacity duration-300 w-[90%]'>
